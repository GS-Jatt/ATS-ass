                        ...
                        <div className=" justify-content-end d-flex">
                            <Dropdown>
                                <Dropdown.Toggle
                                    ...
                                    variant="secondary"
                                    className="write-btn 	d-sm-none d-md-block">
                                    Write Post
                                </Dropdown.Toggle>
                ...
                <div className="col-md-8">
                    <div className="blog-card">
                        ...
                        <div className="card-bottom">
                            ...
                            <p className="subtitle">
                                I’ve worked in UX for the better part of a
                                decade. From now on, I plan to rei…
                            </p>
                    ...
                    <div className="blog-card">
                        ...
                        <div className="card-bottom">
                            ...
                            <div className="d-flex justify-content-between ">
                                <h2 className="title">
                                    Finance & Investment Elite Social Mixer
                                    @Lujiazui
                                </h2>
                                <button className="menu_icon">
                                    {" "}
